...
const Newest = () => {
    return (
        <div className="recent px-16">
            <h1 className="text-gray-600 mt-16 text-3xl  font-semibold font-serif text-center">Newest Arrivals</h1>
            <h2 className="text-gray-400 text-lg mb-14 font-semibold font-serif text-center">Fresh Blooms Just In</h2>
            <Splide
                options={{
                    perPage: 4,
                    perMove: 1,
